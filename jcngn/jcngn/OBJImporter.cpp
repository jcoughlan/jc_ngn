...
void OBJImporter::GetModelFile(char* filename)
{
	bool done;
	ifstream fin;
...
bool OBJImporter::ReadFileCounts(char* filename, int& vertexCount, int& textureCount, int& normalCount, int& faceCount)
{
	ifstream fin;
	char input;
