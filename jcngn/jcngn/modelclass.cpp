...
bool ModelClass::SetPlaneVerticesAndIndices()
{
	int scale = 5; 
...
bool ModelClass::InitializePlane(ID3D11Device* device, WCHAR* textureFilename1, WCHAR* textureFilename2)
{
	m_vertexCount = 4;
	m_indexCount = 6;
	m_model = new ModelType[m_vertexCount];
...
bool ModelClass::InitializePlane(ID3D11Device* device, WCHAR* textureFilename1, WCHAR* textureFilename2, WCHAR* textureFilename3)
{
	m_vertexCount = 4;
	m_indexCount = 6;
	m_model = new ModelType[m_vertexCount];
